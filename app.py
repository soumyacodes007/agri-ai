...
def cropdetail():
    ...
    return render_template('cropdetail.html', context=context)
...
cors = CORS(app, resources={r"/ticker": {"origins": "http://localhost:5000"}})
...
# Initialize commodity_list at the global scope so it works on Render and WSGI servers
